...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-bottom">
        <div class="container" style="border-bottom: none;">
            <a href="topics.html"><div class="pull-left chose"><p>精选话题</p></div></a>
            <a href="function_Introduction.html"><div class="pull-right function"><p>功能介绍</p></div></a>
        </div>
    </nav>
    ...
    <div class="container-fluid">
        <div class="media">
            ...
            <div class="media-body">
                <h3 class="media-heading">道德对于我们有多重要?</h3>
                <p><img src="/playChat/Public/Home/images/shizhong.png"><span>2016-10-11</span><span>14:11:18</span></p>
                <p>简介:道德对于我们有多重要</p>
                <a href="play_room.html"><button class="btn btn-default btn1">进入直播间</button></a>
            </div>
        </div>
        <div class="media">
            <div class="media-left" >
