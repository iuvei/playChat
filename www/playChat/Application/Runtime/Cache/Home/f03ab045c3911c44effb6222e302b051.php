        ...
        <div class="row">
            <div class="col-xs-4">
                <a href="public_play.html">
                    <h4>公开直播</h4>
                    <div><img style="width: 80%;height: auto"  src="/playChat/Public/Home/images/gongkaizhibo.png"></div>
                </a>
            ...
            <div class="col-xs-4">
                ...
                <h4>收费直播</h4>
                <div ><img style="width: 80%;height: auto"  src="/playChat/Public/Home/images/shouferizhibo1.png"></div>
                </a>
                <p style="left: 42%">
