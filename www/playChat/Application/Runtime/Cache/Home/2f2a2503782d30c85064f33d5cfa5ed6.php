...
<div class="container-fluid">
    <div class="bg-box">
        <div class="bg">
            ...
            <div class="bn">
                <a href="setting.html">
                    <button class="btn btn-default" style="margin-left:32%;background-color: #01b0f1;">设置直播间</button>
                </a>
            </div>
            <div class="tex te1">
    ...
    <div class="bt bt7">
        <a href="public_play.html">
            <button class="btn btn-default" style="height: 54px;">创建新的话题</button>
        </a>
    </div>
    <!--历史直播话题-->
    <div class="media med me">
        ...
        <div class="media-body">
            ...
            <p>简介:道德对于我们有多重要</p>
            <button class="btn btn-default btn-1 btn1">查看二维码</button>
            <button class="btn btn-default btn-1 btn2">话题时长续费</button>
            <button class="btn btn-default btn-1 btn3">删除直播</button>
        </div>
    </div>
    <!--历史直播话题-->
    <div class="media med">
